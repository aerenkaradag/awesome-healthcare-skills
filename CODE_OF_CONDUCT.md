...
- Submitting real patient data, protected health information, or other sensitive data in violation of `SECURITY.md`.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the maintainers through a private GitHub channel or by opening a confidential report as described in `SECURITY.md`. All complaints will be reviewed and investigated promptly and fairly.
